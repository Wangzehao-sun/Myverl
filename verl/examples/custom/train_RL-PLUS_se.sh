...
train_path=$HOME/LLM/Train/data/openr1_se_new1.parquet
...
PROJECT_NAME="verl_grpo_${name}_test1_$(basename $MODEL_PATH)"
EXP_NAME="luffy-se"
LOG_DIR=$HOME/LLM/verl/logs/${PROJECT_NAME}
mkdir -p ${LOG_DIR}
...
python -m verl.trainer.main_ppo_new \
    ...
    +actor_rollout_ref.actor.policy_loss.off_policy_reshape="sequence" \
    ...
    +actor_rollout_ref.rollout.n_se=1 \
